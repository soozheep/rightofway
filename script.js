const SITE_URL = 'https://rightofway-soozhee.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Right of Way — Sonic Remedy | Soozhee',
        text: 'Right of Way by Soozhee. Sonic Remedy : Audiosensory Resonance | Trust Your Path.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
